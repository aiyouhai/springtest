        ...
        render: function(callback) {
            ...
            var that = this,
                ...
                _tpl = [                	  
                    ...
                    '{{# if(hasChildren){ }}',
                    '<a href="javascript:;">',
                    '{{# if (item.uid.indexOf("icon-") !== -1) { }}',
                    '<i class="iconfont {{item.uid}}" aria-hidden="true"></i>',
                    '{{# } else { }}',
                    '<i class="iconfont">{{item.uid}}</i>',
                    '{{# } }}',
                    '<span> {{item.text}}</span>',
                    '</a>',
                    ...
                    '<dd>',
                    '<a href="javascript:;" kit-target data-options="{url:\'{{child.url}}\',uid:\'{{child.uid}}\',text:\'{{child.text}}\',id:\'{{child.id}}\'}">',
                    '{{# if (child.uid.indexOf("icon-") !== -1) { }}',
                    '<i class="iconfont {{child.uid}}" aria-hidden="true"></i>',
                    '{{# } else { }}',
                    '<i class="iconfont">{{child.uid}}</i>',
                    '{{# } }}',
                    ...
                    '</dl>',
                    '{{# }else{ }}',
                    '<a href="javascript:;" kit-target data-options="{url:\'{{item.url}}\',uid:\'{{item.uid}}\',text:\'{{item.text}}\',id:\'{{item.id}}\'}">',
                    '{{# if (item.uid.indexOf("icon-") !== -1) { }}',
                    '<i class="iconfont {{item.uid}}" aria-hidden="true"></i>',
                    '{{# } else { }}',
                    '<i class="iconfont">{{item.uid}}</i>',
